...
import { InsightsManagementView } from '@/components/portal/InsightsManagementView';
    ...
    fetch('/api/auth/me')
      ...
      .then((data) => {
        if (data.authenticated && data.user) {
          // STRICT ACCESS CONTROL: Only ADMIN can access Insights CMS
