            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-1.5">
                {project.technologies.map((tech) => (
                  <span
                    key={tech}
                    className="flex items-center gap-1.5 px-2 py-1 rounded-md text-[10px] font-mono bg-theme-surface text-theme-fore border border-theme-border/60"
                  >
                ...
                <div className="space-y-2">
                  {project.links.map((link) => (
                    <a
                      ...
                      className="flex items-center justify-between px-4 py-2.5 rounded-xl bg-theme-surface hover:bg-theme-accent hover:text-theme-base text-xs font-sans font-bold text-theme-fore border border-theme-border transition-all duration-300 group"
                    >
